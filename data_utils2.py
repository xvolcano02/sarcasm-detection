...
# train_dir = '/data/jingliqiang/xiecan/MILNet/data/clean_data/data_label0.txt'
# valid_dir = '/data/jingliqiang/xiecan/MILNet/data/clean_data/data_label0.txt'
# test_dir = '/data/jingliqiang/xiecan/MILNet/data/clean_data/data_label0.txt'
...
class RGDataset(Dataset):
    ...
    #     # raw text bert_indices, bert_mask
    #     text_raw = self.all_text_dic[name]
    #     text_aug = self.aug_text[name]
    #     bert_mask1, bert_indices = self.text_process(text_raw)
    #     bert_mask2, bert_indices = self.text_process(text_aug)
    #     bert_mask=[bert_mask1,bert_mask2]
    ...
    #     # added text bert_indices_add, bert_mask_add
    #     text_add = text_raw + image_text
    #     text_aug_add= text_aug + image_text
    #     bert_mask_add=[]
    #     bert_indices_add=[]
        
    #     mask_add, indices_add = self.text_process(text_add)
    #     bert_mask_add.append(mask_add)
    #     bert_indices_add.append(indices_add)
        
    #     mask_add, indices_add = self.text_process(text_aug_add)
    #     bert_mask_add.append(mask_add)
    #     bert_indices_add.append(indices_add)
    ...
    #     image_path = os.path.join(self.image_path, str(name) + ".jpg")
    #     for i in range(2):
    #         image_trans.append(self.image_process(image_path))  # 3*224*224p
...
class RG2Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #     if p<=5:
        #         label = self.opposite_label_dic[('b'+name)]

        #         # raw text bert_indices, bert_mask
        #         text_raw = self.oppoite_text_dic[('b'+name)]
        #     else:
        #         label = self.all_label_dic[name]
        ...
        # return name,bert_mask, bert_mask_add, bert_indices_add,image_trans,label
        # return bert_mask, bert_mask_add, bert_indices_add,image_trans,label
        return bert_mask, bert_mask, bert_indices,image_trans,label
...
if __name__ == '__main__':
    ...
    #     image = transform(image)
    #     return image
    # a=image_process("/data/jingliqiang/xiecan/data/sarcasm-detection/dataset_image/682716753374351360.jpg").shape
    # print(a)
